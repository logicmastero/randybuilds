...
const QUICK_COMPONENTS: Record<string, string> = {
  ...
  reviews: `<section style="padding:60px 20px;background:white"><h2 style="text-align:center;font-size:2em;font-weight:800;margin-bottom:12px">What Our Clients Say</h2><p style="text-align:center;color:#888;margin-bottom:40px">Trusted by homeowners across Alberta</p><div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px;max-width:1100px;margin:0 auto"><div style="padding:28px;background:#f9f9f9;border-radius:12px;border-left:4px solid #2563eb"><div style="color:#f59e0b;font-size:14px;margin-bottom:10px">★★★★★</div><p style="color:#444;font-style:italic;margin-bottom:16px;line-height:1.7">"Outstanding work, on time and on budget. Highly recommend."</p><strong style="font-size:13px">Sarah J. — Calgary</strong></div><div style="padding:28px;background:#f9f9f9;border-radius:12px;border-left:4px solid #2563eb"><div style="color:#f59e0b;font-size:14px;margin-bottom:10px">★★★★★</div><p style="color:#444;font-style:italic;margin-bottom:16px;line-height:1.7">"Fast, clean, professional. Will definitely use again."</p><strong style="font-size:13px">Mike T. — Edmonton</strong></div><div style="padding:28px;background:#f9f9f9;border-radius:12px;border-left:4px solid #2563eb"><div style="color:#f59e0b;font-size:14px;margin-bottom:10px">★★★★★</div><p style="color:#444;font-style:italic;margin-bottom:16px;line-height:1.7">"Best experience I've had. Quote was fair and the result was perfect."</p><strong style="font-size:13px">Linda K. — Red Deer</strong></div></div></section>`,
              ...
              {rightTab === "seo" && (
                <div style={{ flex: 1, overflowY: "auto", padding: "14px" }}>
                  ...
                  {[
                    ...
                    { label: "Meta Description", placeholder: "We provide professional services in Alberta. Call today for a free quote.", tag: "description" },
                    { label: "OG Title (Social)", placeholder: site.businessName, tag: "og-title" },
                    { label: "Phone Number", placeholder: "(403) 555-0100", tag: "phone" },
                    { label: "Address", placeholder: "Cochrane, Alberta", tag: "address" },
                  ].map(f => (
